...
//dubuff 被动性 睡眠 只执行1次 5秒后失效，被攻击时失效
class GameSkillDebuffSleep extends GameSkillDebuff {
  final LangawGame game;
  final Monster monster;
  double skillCD = 10; //10秒执行一次
  double unavaiableAfterCD =5; //n秒后失效
  int skillDuration = 5; //2持续3秒 3秒后恢复
  int avaiableTimes = 1; //可执行的次数
  bool isImmediate=true;
  GameBuffType gameBuffType = GameBuffType.debuff_sleep;
  GameSkillDebuffSleep(this.game, this.monster,
