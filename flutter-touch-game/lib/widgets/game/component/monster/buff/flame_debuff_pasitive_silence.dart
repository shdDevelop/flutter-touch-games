...
class GameSkillDebuffSilence extends GameSkillDebuff {
  final LangawGame game;
  final Monster monster;
  double skillCD = 10; //10秒执行一次
  double unavaiableAfterCD =10; //n秒后失效
  int skillDuration = 10; //2持续3秒 3秒后恢复
  int avaiableTimes = 1; //可执行的次数
  bool isImmediate=true;
  GameBuffType gameBuffType = GameBuffType.debuff_slience;//沉默
  GameSkillDebuffSilence(this.game, this.monster,
  ...
  @override
  void onSkillExecing() {
    monster?.canUserPositiveSkill = false;
  }

  //自动型
  @override
  void onSkillExeced() {
    monster?.canUserPositiveSkill = true;
   }
}
